...
import SunImage from "../../assets/average-sun-hour-lebanon.png";

const Calculations = () => {
  const [inputs, setInputs] = useState([
    { id: 0, name: "", consumption: "", confirmed: false },
  ]);
  ...
  return (
    <div className="calculation-section">
      <div className="calculation-container">
        ...
        <div className="inputContainer">
          <label className="label">
            Average Sun Hours: Choose from the image the average hour that best
